...
def payment(request):
    ...
    """if not request.user.is_fully_filled():
        messages.info(request, f"Please complete profile details!")
        return redirect("App_Login:profile")"""

    store_id = 'lapto62bb4a1774f30'
    API_key = 'lapto62bb4a1774f30@ssl'
    ...
    mypayment.set_product_integration(total_amount=Decimal(order_total), currency='BDT', product_category='Laptop', product_name=order_items, num_of_item=order_items_count, shipping_method='Courier', product_profile='None')

    current_user = request.user
    mypayment.set_customer_info(name="efan", email="efan@gmail.com", address1='Uttara', address2='BD', city='Dhaka', postcode='2050', country='Bangladesh', phone='01680877725')


    mypayment.set_shipping_info(shipping_to="efan", address="uttara", city="dhaka", postcode="6080", country="Bangladesh")
